    ...
    <div className='min-h-screen bg-bg-two flex flex-col'>
      ...
      <footer className='bg-black text-center  py-6 border-t-[1px] border-t-black z-50 '>
        <div className='flex justify-center gap-6 mb-4 text-white'>
          <a
            href='https://github.com/EddieO23?tab=repositories'
            target='_blank'
          ...
          <a
            href='https://www.twitch.tv/reznovops143'
            target='_blank'
            rel='noopener noreferrer'
            aria-label='twitch'
          >
          ...
          <a
            href='https://www.reddit.com/user/ReznovOps143/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button'
            target='_blank'
            rel='noopener noreferrer'
            aria-label='reddit'
          >
        ...
        <p className='text-white text-sm'>
          &copy; {new Date().getFullYear()} <strong>soberDevEddie</strong>. All
          rights reserved.
        </p>
      </footer>
    </div>
